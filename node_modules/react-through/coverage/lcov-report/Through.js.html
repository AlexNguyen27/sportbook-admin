...
<html lang="en">
<head>
    <title>Code coverage report for Through.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> Through.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  componentDidMount() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if(this.state.dataNum != this.dataNum) {
...
&nbsp;
    if( syncUpdate ) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if(this.canSetState) {
...
<span class="branch-0 cbranch-no" title="branch not covered" >      bearingKey </span>:
...
&nbsp;
export default Through</pre></td></tr>
</table></pre>
